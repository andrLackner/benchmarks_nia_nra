...
; Benchmark: 		freire2_norm_inv1_len5_5
...
; Testing invariant: -6*r^3*x + 3*r^3*s^3*x^3 + 3*r^4*x + r^2*s00*x^2 + r*s^3*s00*x^3 - 3*r^2*r00^2*x^2 + r^2*s00*x + 3*r^4*x^2 - 2*r*s00*x + 6*r*r00^2*x - 3*r*r00^2*s^3*x^3 + 2*r*s*x - r^2*s*x - r^2*s*x^2 - 3*r^2*r00^2*x - r*s^4*x^3
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (* (- 6) (+ r 1) (+ r 1) (+ r 1) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (- x s)) (* (+ r 1) (+ r 1) s00 (- x s) (- x s)) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) r00 r00 (- x s) (- x s))) (* (+ r 1) (+ r 1) s00 (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (- x s) (- x s))) (* 2 (+ r 1) s00 (- x s))) (* 6 (+ r 1) r00 r00 (- x s))) (* 3 (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 2 (+ r 1) (+ s (* 6 r) 3) (- x s))) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) r00 r00 (- x s)) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) 0))
			)
		)
	)
)
