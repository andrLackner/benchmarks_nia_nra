...
; Benchmark: 		cohencu_denorm_inv1_len2_4
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (n^3*x*y^2 + n*x*y*z^2)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (+ (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z)) (* (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
