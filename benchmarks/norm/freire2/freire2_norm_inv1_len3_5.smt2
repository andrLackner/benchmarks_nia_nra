...
; Benchmark: 		freire2_norm_inv1_len3_5
...
; Testing invariant: -r^3*s00 - 3*r^2*s^3*x - 3*r^3*s^3*x^2 - r*s^3*s00*x^2 - 3*r^5 + r^3*s - s^3*s00*x + s^4*x + r*s^4*x^2 + 3*r00^2*s^3*x + 3*r^3*r00^2 + 3*r*r00^2*s^3*x^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (* (- 1) (+ r 1) (+ r 1) (+ r 1) s00) (* 3 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ r 1))) (* (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3))) (* (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s))) (* (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* 3 r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) r00 r00) (* 3 (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) 0))
			)
		)
	)
)
