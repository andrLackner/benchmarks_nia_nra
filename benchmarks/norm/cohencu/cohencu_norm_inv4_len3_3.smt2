...
; Benchmark: 		cohencu_norm_inv4_len3_3
...
; Testing invariant: 0*n*x^3*y^2*z00 + 18*n*x^4*y^2*z + 108*n*x^3*x00*y^2 + 72*n*x^3*y^2*y00 + n*x^3*y^2*y00*z*z00 - 6*n*x^3*y^2*y00*z00 - 12*n*x^3*y^2*y00*z + 12*n*x^3*y^3*z + 24*n*x^3*y^2*y00^2 - 108*n*x^4*y^2 + 0*n*x^3*y*y00*z*z00 - 18*n*x^3*x00*y^2*z + 0*n*x^4*y - 18*n*x^3*x00*y^2*z00 + 0*n*x^3*y*y00 - 12*n*x^3*y^3*y00 + 6*n*x^3*y^3*z00 - 12*n*x^3*y^4 + 0*n*x^4*y*z00 + 0*n*x^3*x00*y*z + 0*n*x^3*y*y00*z00 + 0*n*x^3*y^2*z*z00 + n*x^3*y^3*z00^2 + 0*n*x^3*y^2 + 0*n*x^3*y^2*z - 72*n*x^3*y^3 - n*x^3*y^2*y00*z00^2 + 18*n*x^4*y^2*z00 + 0*n*x^4*y*z + 0*n*x^3*x00*y*z00 + 0*n*x^3*x00*y + 0*n*x^3*y*y00*z00^2 + 0*n*x^3*y^2*z00^2 + 0*n*x^3*y*y00^2 + 0*n*x^3*y*y00*z - n*x^3*y^3*z*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) z00) (* 18 (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)) (* 108 (+ n 1) (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ y z)) (* 72 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6) z00)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 z00) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6))) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6)) (* 24 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 y00)) (* 108 (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z))) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6) z00)) (* 18 (+ n 1) (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ y z) (+ z 6))) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z))) (* 18 (+ n 1) (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ y z) z00)) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) z00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z))) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) z00) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ z 6)) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 z00) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) z00 z00) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z)) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6))) (* 72 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 z00 z00)) (* 18 (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) z00) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6)) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) x00 (+ y z) z00) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) x00 (+ y z)) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 z00 z00) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) z00 z00) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 y00) (* 0 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00)) 0))
			)
		)
	)
)
