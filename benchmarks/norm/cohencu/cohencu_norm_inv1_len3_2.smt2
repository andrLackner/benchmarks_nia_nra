...
; Benchmark: 		cohencu_norm_inv1_len3_2
...
; Testing invariant: n^3*x^2*z*z00 - 6*n^4*x^3*y^3*z + 6*n^3*n00*x^3*y^3*z - 6*n^3*n00*x^2*z - n^3*x^3*y^3*z*z00 + 6*n00*x^3*z^3 + x^3*z^4 - 6*n*x^3*z^3 + n^3*x^3*y^3*z^2 - n^3*x^2*z^2 + 6*n^4*x^2*z - x^3*z^3*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6) z00) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00)) (* 6 n00 (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6)) (* (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6))) (* (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00)) 0))
			)
		)
	)
)
