...
; Benchmark: 		cohencu_norm_inv1_len4_3
...
; Testing invariant: -x*z^4 - 6*n*n00*y*z^2 - n*y*z^3 + x*z^3*z00 + 6*n*x*z^3 + 6*n*n00*x^3*y^2*z^2 + 6*n^2*x^2*y*z^2 - 6*n^2*x^3*y^2*z^2 - 6*n*n00*x^2*y*z^2 + n*x^3*y^2*z^3 + n*y*z^2*z00 + n*x^2*y*z^2*z00 - 6*n00*x*z^3 + 6*n^2*y*z^2 - n*x^2*y*z^3 - n*x^3*y^2*z^2*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (* (- 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) n00 (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ x y) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) n00 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) n00 (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ y z) (+ z 6) (+ z 6) z00) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) z00)) (* 6 n00 (+ x y) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) 0))
			)
		)
	)
)
