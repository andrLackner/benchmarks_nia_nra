...
; Benchmark: 		cohencu_norm_inv1_len4_2
...
; Testing invariant: x*z - n^2*x^3*y*z^3 + 6*n^2*n00*y^3*z - n^2*y^3*z*z00 - 6*n*x + n^2*y^3*z^2 + 6*n^2*n00*x^3*y^2 - 6*n^3*y^3*z + n^2*x^3*y*z^2*z00 + 6*n00*x + 6*n^3*x^3*y*z^2 - x*z00 + n^2*x^3*y^2*z - 6*n^3*x^3*y^2 - n^2*x^3*y^2*z00 - 6*n^2*n00*x^3*y*z^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (* (+ x y) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) n00 (+ y z) (+ y z) (+ y z) (+ z 6))) (* (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) z00) (* 6 (+ n 1) (+ x y))) (* (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) z00) (* 6 n00 (+ x y)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* (+ x y) z00)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) z00) (* 6 (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
