...
; Benchmark: 		cohencu_norm_inv2_len3_4
...
; Testing invariant: -n^3*y^2*z^3*z00^2 - n*y^2*z^2 + 12*n^3*y^2*y00*z^3 - 12*n^3*y^3*y00*z - 6*n^3*y^3*z*z00 + n^3*y^3*z*z00^2 + n*y^2*z00^2 - 13*n^3*y^3*z^3 + 12*n^3*y^4*z + 12*n*y^3 + n^3*y^2*z^5 - 6*n^3*y^2*z^4 + 6*n^3*y^2*z^3*z00 - 6*n*y^2*z00 - 12*n*y^2*y00 + 6*n^3*y^3*z^2 + 6*n*y^2*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 1) (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00) (* (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) y00 (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) z00)) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00) (* (+ n 1) (+ y z) (+ y z) z00 z00)) (* 13 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6)) (* 12 (+ n 1) (+ y z) (+ y z) (+ y z)) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00)) (* 6 (+ n 1) (+ y z) (+ y z) z00) (* 12 (+ n 1) (+ y z) (+ y z) y00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ y z) (+ y z) (+ z 6))) 0))
			)
		)
	)
)
