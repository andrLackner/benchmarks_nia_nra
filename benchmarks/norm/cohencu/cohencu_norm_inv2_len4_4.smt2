...
; Benchmark: 		cohencu_norm_inv2_len4_4
...
; Testing invariant: -12*n^3*x*y^2 + 12*n^3*y*z^3 - 6*n^3*z^3*z00 + 6*x^3*y*z^3*z00 - 6*n^2*x^2*y*z + n^2*x^2*y*z^2 - x^3*y*z^3*z00^2 - 6*n^3*x*y*z + n^3*x*y*z^2 + n^3*z^3*z00^2 + 12*x^3*y*y00*z^3 - 12*x^3*y^2*z^3 + 6*n^3*x*y*z00 - 12*n^3*y00*z^3 + 12*n^3*x*y*y00 - n^3*z^5 - n^3*x*y*z00^2 - n^2*x^2*y*z00^2 + 6*n^3*z^4 - 12*n^2*x^2*y^2 + 12*n^2*x^2*y*y00 + 6*n^2*x^2*y*z00 - 6*x^3*y*z^4 + x^3*y*z^5
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 12) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ z 6) (+ z 6) (+ z 6) z00)) (* 6 (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ z 6) (+ z 6) (+ z 6) z00 z00) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) z00)) (* 12 (+ n 1) (+ n 1) (+ n 1) y00 (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) y00)) (* (+ n 1) (+ n 1) (+ n 1) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) z00 z00) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) z00 z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z))) (* 12 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) y00) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) z00)) (* 6 (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
