...
; Benchmark: 		cohencu_norm_inv1_len3_5
...
; Testing invariant: n*x*y^2*z^3 - 6*n^3*x^3 + n^2*x^3*z - 6*n^2*x*y^2*z^2 + 6*n^3*x^3*y^2*z + 6*n*n00*x*y^2*z^2 - 6*n^2*n00*x^3*y^2*z - n^2*x^3*z00 - n^2*x^3*y^2*z^2 - n*x*y^2*z^2*z00 + n^2*x^3*y^2*z*z00 + 6*n^2*n00*x^3
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)) (* 6 (+ n 1) n00 (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) z00) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00) (* 6 (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ x y))) 0))
			)
		)
	)
)
