...
; Benchmark: 		cohencu_norm_inv3_len2_1
...
; Testing invariant: -6*n^2*y^2*z + 6*n^2*y*z00^2 - 6*n^3*y*z*z00 + 6*n^3*y*z00^2 - 12*n^3*y*y00*z + 18*n^3*y*y00*z00 - n^3*y*z00^3 - 12*n^2*y*y00*z - 6*n^2*y*z*z00 + 18*n^2*y*y00*z00 - 6*n^3*y^2*z - 72*n^2*y*y00 - n^2*y*z00^3 - 108*n^2*x00*y + 72*n^3*y^2 + n^3*y*z*z00^2 + 72*n^2*y^2 + n^2*y*z*z00^2 + 108*n^2*x*y + 108*n^3*x*y - 108*n^3*x00*y - 72*n^3*y*y00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 6) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ y z) z00 z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ z 6) z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) z00 z00)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ y z) y00 (+ z 6))) (* 18 (+ n 1) (+ n 1) (+ n 1) (+ y z) y00 z00)) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) z00 z00 z00) (* 12 (+ n 1) (+ n 1) (+ y z) y00 (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ y z) (+ z 6) z00)) (* 18 (+ n 1) (+ n 1) (+ y z) y00 z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6)) (* 72 (+ n 1) (+ n 1) (+ y z) y00) (* (+ n 1) (+ n 1) (+ y z) z00 z00 z00) (* 108 (+ n 1) (+ n 1) x00 (+ y z))) (* 72 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z)) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ z 6) z00 z00) (* 72 (+ n 1) (+ n 1) (+ y z) (+ y z)) (* (+ n 1) (+ n 1) (+ y z) (+ z 6) z00 z00) (* 108 (+ n 1) (+ n 1) (+ x y) (+ y z)) (* 108 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z))) (* 108 (+ n 1) (+ n 1) (+ n 1) x00 (+ y z)) (* 72 (+ n 1) (+ n 1) (+ n 1) (+ y z) y00)) 0))
			)
		)
	)
)
