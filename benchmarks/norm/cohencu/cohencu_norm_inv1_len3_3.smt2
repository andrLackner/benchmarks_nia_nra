...
; Benchmark: 		cohencu_norm_inv1_len3_3
...
; Testing invariant: -6*n^2*y^2 + 6*n*x*y^3 + 6*n*n00*y^2 - n*y^2*z00 - 6*n00*x*y^3 - x^2*y^2*z^3 - x*y^3*z + x^2*y^2*z^2*z00 + 6*n*x^2*y^2*z^2 - 6*n00*x^2*y^2*z^2 + n*y^2*z + x*y^3*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (* (- 6) (+ n 1) (+ n 1) (+ y z) (+ y z)) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z)) (* 6 (+ n 1) n00 (+ y z) (+ y z))) (* (+ n 1) (+ y z) (+ y z) z00) (* 6 n00 (+ x y) (+ y z) (+ y z) (+ y z)) (* (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 n00 (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ y z) (+ y z) (+ z 6)) (* (+ x y) (+ y z) (+ y z) (+ y z) z00)) 0))
			)
		)
	)
)
