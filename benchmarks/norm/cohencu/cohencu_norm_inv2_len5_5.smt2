...
; Benchmark: 		cohencu_norm_inv2_len5_5
...
; Testing invariant: -n^3*x^2*y^3*z^3 + 6*n^3*x^2*y^3*z^2 - 6*n*x*y^3*z^3*z00 + 12*n*y00*z^3 + 12*n*x*y^4*z^3 - 12*n*x*y^2*z^2 - 6*n*x*y*z^3 + n*x*y*z^4 - n*x^3*y^2*z*z00^2 + 12*n*x^3*y^2*y00*z - 12*n*x^3*y^3*z + n*z^5 + n*x*y^3*z^3*z00^2 - 6*n*z^4 + n^3*x^2*y^3*z*z00^2 - n*z^3*z00^2 + 12*n*x*y*y00*z^2 + 6*n*z^3*z00 + 6*n*x*y*z^2*z00 - n*x*y^3*z^5 + 6*n*x*y^3*z^4 - 12*n*y*z^3 + 12*n^3*x^2*y^4*z - 6*n^3*x^2*y^3*z*z00 - n*x*y*z^2*z00^2 - 6*n*x^3*y^2*z^2 + 6*n*x^3*y^2*z*z00 + n*x^3*y^2*z^3 - 12*n*x*y^3*y00*z^3 - 12*n^3*x^2*y^3*y00*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00)) (* 12 (+ n 1) y00 (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6))) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* (+ n 1) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 6 (+ n 1) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00)) (* (+ n 1) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ x y) (+ y z) y00 (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) z00)) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00) (* (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) z00 z00) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6))) 0))
			)
		)
	)
)
