...
; Benchmark: 		cohencu_norm_inv2_len2_5
...
; Testing invariant: n^2*x*y^2*z^2 - 6*n^2*x*y^2*z - n^2*x*y^2*z00^2 - 12*n^2*x*y^3 + 6*n^2*x*y^2*z00 + 6*x^3*z00 + 12*n^2*x*y^2*y00 + 12*x^3*y00 - x^3*z00^2 - 6*x^3*z + x^3*z^2 - 12*x^3*y
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) z00 z00) (* 12 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) z00) (* 6 (+ x y) (+ x y) (+ x y) z00) (* 12 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) y00) (* 12 (+ x y) (+ x y) (+ x y) y00)) (* (+ x y) (+ x y) (+ x y) z00 z00) (* 6 (+ x y) (+ x y) (+ x y) (+ z 6))) (* (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6))) (* 12 (+ x y) (+ x y) (+ x y) (+ y z))) 0))
			)
		)
	)
)
