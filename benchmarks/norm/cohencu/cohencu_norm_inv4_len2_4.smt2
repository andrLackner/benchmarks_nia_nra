...
; Benchmark: 		cohencu_norm_inv4_len2_4
...
; Testing invariant: -12*n*x*y^5 - n*x*y^4*z*z00 + 18*n*x^2*y^3*z00 - 72*n*x*y^4 - 12*n*x^2*y*y00*z^2 + 18*n*x^2*y^3*z - 108*n*x^2*y^3 + n*x*y^4*z00^2 + 108*n*x*x00*y^3 - 12*n*x*y^3*y00*z - 6*n*x^2*y00*z^2*z00 + 6*n*x^2*y*z^2*z00 - 18*n*x^2*x00*z^2*z00 + 72*n*x*y^3*y00 + 12*n*x^2*y*z^3 + 24*n*x^2*y00^2*z^2 + 12*n*x*y^4*z - 72*n*x^2*y*z^2 + n*x*y^3*y00*z*z00 - n*x^2*y00*z^2*z00^2 + 18*n*x^3*z^3 + 24*n*x*y^3*y00^2 - 6*n*x*y^3*y00*z00 + 18*n*x^3*z^2*z00 - 12*n*x^2*y00*z^3 + 72*n*x^2*y00*z^2 - n*x*y^3*y00*z00^2 + n*x^2*y*z^2*z00^2 + n*x^2*y00*z^3*z00 - n*x^2*y*z^3*z00 - 18*n*x*x00*y^3*z00 - 12*n*x^2*y^2*z^2 - 108*n*x^3*z^2 + 6*n*x*y^4*z00 - 12*n*x*y^4*y00 + 108*n*x^2*x00*z^2 - 18*n*x*x00*y^3*z - 18*n*x^2*x00*z^3
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 12) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ y z)) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6) z00)) (* 18 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) z00)) (* 72 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z)) (* 12 (+ n 1) (+ x y) (+ x y) (+ y z) y00 (+ z 6) (+ z 6))) (* 18 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 108 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z))) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) z00 z00) (* 108 (+ n 1) (+ x y) x00 (+ y z) (+ y z) (+ y z))) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) y00 (+ z 6) (+ z 6) z00)) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) z00)) (* 18 (+ n 1) (+ x y) (+ x y) x00 (+ z 6) (+ z 6) z00)) (* 72 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00) (* 12 (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 24 (+ n 1) (+ x y) (+ x y) y00 y00 (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 72 (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6) z00)) (* (+ n 1) (+ x y) (+ x y) y00 (+ z 6) (+ z 6) z00 z00)) (* 18 (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6)) (* 24 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 y00)) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 z00)) (* 18 (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) z00)) (* 12 (+ n 1) (+ x y) (+ x y) y00 (+ z 6) (+ z 6) (+ z 6))) (* 72 (+ n 1) (+ x y) (+ x y) y00 (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 z00 z00)) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) z00 z00) (* (+ n 1) (+ x y) (+ x y) y00 (+ z 6) (+ z 6) (+ z 6) z00)) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* 18 (+ n 1) (+ x y) x00 (+ y z) (+ y z) (+ y z) z00) (* 12 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 108 (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) z00)) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) y00)) (* 108 (+ n 1) (+ x y) (+ x y) x00 (+ z 6) (+ z 6))) (* 18 (+ n 1) (+ x y) x00 (+ y z) (+ y z) (+ y z) (+ z 6)) (* 18 (+ n 1) (+ x y) (+ x y) x00 (+ z 6) (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
