...
; Benchmark: 		cohencu_norm_inv1_len3_1
...
; Testing invariant: -n^3*x^3*z^3*z00 + 6*n^3*x^2*y^2*z + 6*n^4*x^3 - 6*n^4*x^3*z^3 - 6*n^3*n00*x^3 - 6*n^2*n00*x^2*y^2*z + n^3*x^3*z^4 - n^3*x^3*z - n^2*x^2*y^2*z^2 + 6*n^3*n00*x^3*z^3 + n^2*x^2*y^2*z*z00 + n^3*x^3*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (* (- 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ x y)) (* 6 (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) z00)) 0))
			)
		)
	)
)
