...
; Benchmark: 		cohencu_norm_inv3_len3_1
...
; Testing invariant: -18*n*y^2*y00*z00 - 108*n*x*y^2 - 72*n*x^3*y*y00*z^3 - 12*n*x^3*y*y00*z^4 - 72*y^3 - 108*n*x^3*x00*y*z^3 + n*x^3*y*z^4*z00^2 - 6*n*x^3*y*z^4*z00 - 72*n*y^3 + 6*y^3*z + 108*x00*y^2 + 72*n*y^2*y00 - 18*y^2*y00*z00 - y^2*z*z00^2 + 6*n*y^3*z + 12*y^2*y00*z + 18*n*x^3*y*y00*z^3*z00 + 6*n*y^2*z*z00 - 6*n*x^3*y^2*z^4 + 108*n*x00*y^2 + 6*n*x^3*y*z^3*z00^2 - 108*x*y^2 - n*x^3*y*z^3*z00^3 + n*y^2*z00^3 + 72*n*x^3*y^2*z^3 - 6*n*y^2*z00^2 + 12*n*y^2*y00*z + 72*y^2*y00 - 6*y^2*z00^2 - n*y^2*z*z00^2 + y^2*z00^3 + 108*n*x^4*y*z^3 + 6*y^2*z*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 18) (+ n 1) (+ y z) (+ y z) y00 z00) (* 108 (+ n 1) (+ x y) (+ y z) (+ y z)) (* 72 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 72 (+ y z) (+ y z) (+ y z)) (* 108 (+ n 1) (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00) (* 72 (+ n 1) (+ y z) (+ y z) (+ y z))) (* 6 (+ y z) (+ y z) (+ y z) (+ z 6)) (* 108 x00 (+ y z) (+ y z)) (* 72 (+ n 1) (+ y z) (+ y z) y00)) (* 18 (+ y z) (+ y z) y00 z00) (* (+ y z) (+ y z) (+ z 6) z00 z00)) (* 6 (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6)) (* 12 (+ y z) (+ y z) y00 (+ z 6)) (* 18 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ y z) (+ y z) (+ z 6) z00)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 108 (+ n 1) x00 (+ y z) (+ y z)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 108 (+ x y) (+ y z) (+ y z)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00 z00)) (* (+ n 1) (+ y z) (+ y z) z00 z00 z00) (* 72 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ y z) (+ y z) z00 z00)) (* 12 (+ n 1) (+ y z) (+ y z) y00 (+ z 6)) (* 72 (+ y z) (+ y z) y00)) (* 6 (+ y z) (+ y z) z00 z00) (* (+ n 1) (+ y z) (+ y z) (+ z 6) z00 z00)) (* (+ y z) (+ y z) z00 z00 z00) (* 108 (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ y z) (+ y z) (+ z 6) z00)) 0))
			)
		)
	)
)
