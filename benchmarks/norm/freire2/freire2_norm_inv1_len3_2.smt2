...
; Benchmark: 		freire2_norm_inv1_len3_2
...
; Testing invariant: s00*x - 3*r^2*r00^2*s + r^2*s*s00 - r^3*s^3*x^2 - s*x - 3*r00^2*x + 3*r^2*x + 3*r^5*s^2*x^2 - 3*r^3*r00^2*s^2*x^2 - r^2*s^2 + r^3*s^2*s00*x^2 + 3*r^4*s
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (* s00 (- x s)) (* 3 (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3))) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) s00)) (* (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* (+ s (* 6 r) 3) (- x s)) (* 3 r00 r00 (- x s))) (* 3 (+ r 1) (+ r 1) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3))) 0))
			)
		)
	)
)
