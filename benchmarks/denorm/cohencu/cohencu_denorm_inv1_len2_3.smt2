...
; Benchmark: 		cohencu_denorm_inv1_len2_3
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (n^2*x*z^3 + y^2*z^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (+ (* (+ n 1) (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6)) (* (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
