...
; Benchmark: 		cohencu_norm_inv1_len2_5
...
; Testing invariant: -x^2*z*z00 - n^3*x^3*y*z^3 + x^2*z^2 + 6*n^4*x^3*y*z^2 - 6*n*x^2*z - 6*n^3*n00*x^3*y*z^2 + n^3*x^3*y*z^2*z00 + 6*n00*x^2*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (* (- 1) (+ x y) (+ x y) (+ z 6) z00) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ x y) (+ x y) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ x y) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) z00) (* 6 n00 (+ x y) (+ x y) (+ z 6))) 0))
			)
		)
	)
)
