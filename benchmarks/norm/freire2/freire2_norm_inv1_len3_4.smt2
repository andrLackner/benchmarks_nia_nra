...
; Benchmark: 		freire2_norm_inv1_len3_4
...
; Testing invariant: -3*r*r00^2*x^2 + r*s00*x^2 - 3*r00^2*s*x^2 - 3*r^4*x - s^2*x^2 - r*s*x^2 - r^2*s00*x + s*s00*x^2 + r^2*s*x + 3*r^2*s*x^2 + 3*r^3*x^2 + 3*r^2*r00^2*x
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (* (- 3) (+ r 1) r00 r00 (- x s) (- x s)) (* (+ r 1) s00 (- x s) (- x s))) (* 3 r00 r00 (+ s (* 6 r) 3) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (- x s)) (* (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s)) (* (+ r 1) (+ r 1) s00 (- x s))) (* (+ s (* 6 r) 3) s00 (- x s) (- x s)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s)) (* 3 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) r00 r00 (- x s))) 0))
			)
		)
	)
)
