...
; Benchmark: 		cohencu_denorm_inv1_len2_5
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (n^3*x^2*y^3*z^3 - n^3*z)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (- (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ z 6)))) 0))
			)
		)
	)
)
