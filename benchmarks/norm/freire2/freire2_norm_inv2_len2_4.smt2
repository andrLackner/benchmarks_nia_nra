...
; Benchmark: 		freire2_norm_inv2_len2_4
...
; Testing invariant: -12*r*r00^2*x^2 + 3*s00*x^2 + 6*r^3*s^3*x^3*x00 - 3*r^3*s^3*s00*x^3 - 12*r^3*r00^3*s^3*x^3 + 3*r^3*s^4*x^3 - 2*r^4*s^4*x^3 - 3*r^4*s^3*x^3 - 6*r^3*s^3*x^4 + 3*r^3*r00*s^3*x^3 - 6*x^2*x00 + 6*x^3 + 3*r*x^2 - 3*s*x^2 + 6*r^3*r00*s^3*s00*x^3 + 12*r^4*r00^2*s^3*x^3 + 4*r*s00*x^2 + 2*r*s*x^2 - 4*r^4*s^3*s00*x^3 + 12*r00^3*x^2 - 6*r00*s00*x^2 - 3*r00*x^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 12) (+ r 1) r00 r00 (- x s) (- x s)) (* 3 s00 (- x s) (- x s)) (* 6 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) x00)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s)) (* 12 (+ r 1) (+ r 1) (+ r 1) r00 r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 2 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 6 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 6 (- x s) (- x s) x00)) (* 6 (- x s) (- x s) (- x s)) (* 3 (+ r 1) (- x s) (- x s))) (* 3 (+ s (* 6 r) 3) (- x s) (- x s))) (* 6 (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s)) (* 12 (+ r 1) (+ r 1) (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 4 (+ r 1) s00 (- x s) (- x s)) (* 2 (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s))) (* 4 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s))) (* 12 r00 r00 r00 (- x s) (- x s))) (* 6 r00 s00 (- x s) (- x s)) (* 3 r00 (- x s) (- x s))) 0))
			)
		)
	)
)
