...
; Benchmark: 		freire2_norm_inv3_len2_4
...
; Testing invariant: 3*r^3*s00 - 9*r^3*r00*s00 + 18*r^4*s*x^3 - 9*r^4*s^2*x^2 + 2*r^3*s^3*x^2 - 18*r^4*x - 4*r^3*s*s00^2*x^2 + 18*r^3*r00*x00 + 9*r^3*r00*s*s00*x^2 + 2*r^3*s^2*s00*x^2 + 6*r^4*r00*s^2*x^2 - 3*r^3*s*s00*x^2 - 2*r^3*s*s00 - 6*r^3*r00^2*s^2*x^2 + 9*r^4*s*s00*x^2 + 9*r^4*s - 18*r^4*s*x^2*x00 + 4*r^3*s00^2 - 6*r^3*r00^2*s00 + 3*r^3*s^2*x^2 - 9*r^4*s00 - 9*r^3*r00*s^2*x^2 - 18*r^3*r00*s*x^2*x00 - 6*r^4*r00*s*s00*x^2 - 2*r^3*s^2 + 6*r^3*r00^2*s*s00*x^2 - 6*r^4*r00*s - 3*r^3*s + 9*r^3*r00*s + 6*r^4*r00*s00 - 18*r^3*r00*x + 6*r^3*r00^2*s + 18*r^4*x00 + 18*r^3*r00*s*x^3
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* 3 (+ r 1) (+ r 1) (+ r 1) s00) (* 9 (+ r 1) (+ r 1) (+ r 1) r00 s00)) (* 18 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 9 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 2 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 18 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (- x s)) (* 4 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) s00 s00 (- x s) (- x s))) (* 18 (+ r 1) (+ r 1) (+ r 1) r00 x00) (* 9 (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) s00 (- x s) (- x s)) (* 2 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s)) (* 6 (+ r 1) (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) s00 (- x s) (- x s)) (* 2 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) s00) (* 6 (+ r 1) (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 9 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) s00 (- x s) (- x s)) (* 9 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3))) (* 18 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s) x00)) (* 4 (+ r 1) (+ r 1) (+ r 1) s00 s00)) (* 6 (+ r 1) (+ r 1) (+ r 1) r00 r00 s00)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 9 (+ r 1) (+ r 1) (+ r 1) (+ r 1) s00) (* 9 (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* 18 (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) (- x s) (- x s) x00) (* 6 (+ r 1) (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) s00 (- x s) (- x s)) (* 2 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 6 (+ r 1) (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3) s00 (- x s) (- x s))) (* 6 (+ r 1) (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3))) (* 9 (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3)) (* 6 (+ r 1) (+ r 1) (+ r 1) (+ r 1) r00 s00)) (* 18 (+ r 1) (+ r 1) (+ r 1) r00 (- x s))) (* 6 (+ r 1) (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3)) (* 18 (+ r 1) (+ r 1) (+ r 1) (+ r 1) x00) (* 18 (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) 0))
			)
		)
	)
)
