...
; Benchmark: 		cohencu_norm_inv2_len4_2
...
; Testing invariant: 12*n^3*x*y^2*z^3 + n*x^3*y^3*z^2*z00^2 + n^3*x*y*z^3*z00^2 - 12*n^3*x*y*y00*z^3 + 6*n^3*x*y*z^4 + 6*x*y*z00 + 12*x*y*y00 - n^3*x*y*z^5 - 12*n*x^3*y^3*y00*z^2 - 12*x*y^2 + 6*n*x^3*y^3*z^3 - n*x^3*y^3*z^4 + 12*n*x^3*y^4*z^2 + 6*n^3*y^2*z^2*z00 + n^3*y^2*z^4 - 6*n^3*y^2*z^3 - 12*n^3*y^3*z^2 - 6*x*y*z - n^3*y^2*z^2*z00^2 + 12*n^3*y^2*y00*z^2 - 6*n*x^3*y^3*z^2*z00 - 6*n^3*x*y*z^3*z00 - x*y*z00^2 + x*y*z^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ x y) (+ y z) z00) (* 12 (+ x y) (+ y z) y00)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6) (+ z 6)) (* 12 (+ x y) (+ y z) (+ y z))) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) z00) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ x y) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) y00 (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* (+ x y) (+ y z) z00 z00)) (* (+ x y) (+ y z) (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
