...
; Benchmark: 		cohencu_denorm_inv1_len5_4
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (x*y + n^3*x^3*y^2*z + n^2*y^3 + n^3*x*y^2*z + n*x^3*y^2*z)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (+ (* (+ x y) (+ y z)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)))) 0))
			)
		)
	)
)
