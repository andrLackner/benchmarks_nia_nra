...
; Benchmark: 		cohencu_norm_inv2_len5_3
...
; Testing invariant: -12*n^3*x*y^4*z - n^3*x*y^3*z*z00^2 - n*x^3*y^2*z*z00^2 + n*x^3*y^3*z^3 + 12*n*x^3*y^2*y00*z - 12*n*x^3*y^3*z + 12*n^3*x*y^3*y00*z + 6*n^2*x*y^3*z + 12*n^2*x*y^4 + 12*n*x^3*y^3*y00*z - n^2*x^2*y^3*z*z00^2 + 12*n^2*x^2*y^3*y00*z + n^3*x*y^3*z^3 - 6*n^3*x*y^3*z^2 - 12*n^2*x^2*y^4*z - n^2*x*y^3*z^2 - 6*n^2*x^2*y^3*z^2 + n^2*x^2*y^3*z^3 - n*x^3*y^3*z*z00^2 - 6*n*x^3*y^2*z^2 + 6*n*x^3*y^2*z*z00 + n*x^3*y^2*z^3 + n^2*x*y^3*z00^2 - 12*n*x^3*y^4*z - 6*n*x^3*y^3*z^2 - 12*n^2*x*y^3*y00 + 6*n^3*x*y^3*z*z00 - 6*n^2*x*y^3*z00 + 6*n^2*x^2*y^3*z*z00 + 6*n*x^3*y^3*z*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 12) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00 z00)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6))) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) z00 z00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) z00)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00)) 0))
			)
		)
	)
)
