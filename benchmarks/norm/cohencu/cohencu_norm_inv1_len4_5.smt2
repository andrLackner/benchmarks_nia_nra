...
; Benchmark: 		cohencu_norm_inv1_len4_5
...
; Testing invariant: n^3*y^2*z00 + n^3*z - 6*n^4 + 6*n^3*y*z^3 - 6*n*x*y^3*z^3 - x*y^3*z^3*z00 - 6*n^3*n00*y^2 - n^3*y^2*z + 6*n00*x*y^3*z^3 - n^3*z00 + x*y^3*z^4 + 6*n^3*n00 + n^2*y*z^3*z00 + 6*n^4*y^2 - n^2*y*z^4 - 6*n^2*n00*y*z^3
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) z00) (* (+ n 1) (+ n 1) (+ n 1) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ n 1) (+ n 1) n00 (+ y z) (+ y z)) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6))) (* 6 n00 (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) z00)) (* (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) n00) (* (+ n 1) (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z))) (* (+ n 1) (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) n00 (+ y z) (+ z 6) (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
