...
; Benchmark: 		cohencu_norm_inv3_len2_5
...
; Testing invariant: 108*n^3*x*y^3*z^2 - 108*x*x00*y^3 + x*y^3*z*z00^2 + n^3*y^3*z^3*z00^2 + 108*x^2*y^3 - 72*x*y^3*y00 - 12*n^3*y^3*y00*z^3 - 72*n^3*y^3*y00*z^2 + 18*n^3*y^3*y00*z^2*z00 + 72*x*y^4 - 6*x*y^4*z - 108*n^3*x00*y^3*z^2 + 6*n^3*y^3*z^2*z00^2 - n^3*y^3*z^2*z00^3 + 72*n^3*y^4*z^2 - 6*n^3*y^4*z^3 + 6*x*y^3*z00^2 - 6*x*y^3*z*z00 - x*y^3*z00^3 - 12*x*y^3*y00*z + 18*x*y^3*y00*z00 - 6*n^3*y^3*z^3*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* 108 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 108 (+ x y) x00 (+ y z) (+ y z) (+ y z))) (* (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00) (* 108 (+ x y) (+ x y) (+ y z) (+ y z) (+ y z))) (* 72 (+ x y) (+ y z) (+ y z) (+ y z) y00) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6)) (* 72 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) y00 (+ z 6) (+ z 6))) (* 18 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) z00) (* 72 (+ x y) (+ y z) (+ y z) (+ y z) (+ y z))) (* 6 (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6)) (* 108 (+ n 1) (+ n 1) (+ n 1) x00 (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00)) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00 z00)) (* 72 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ x y) (+ y z) (+ y z) (+ y z) z00 z00)) (* 6 (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00) (* (+ x y) (+ y z) (+ y z) (+ y z) z00 z00 z00) (* 12 (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6))) (* 18 (+ x y) (+ y z) (+ y z) (+ y z) y00 z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00)) 0))
			)
		)
	)
)
