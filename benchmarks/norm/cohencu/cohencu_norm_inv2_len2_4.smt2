...
; Benchmark: 		cohencu_norm_inv2_len2_4
...
; Testing invariant: -6*n^2*x*y^2*z^3*z00 + x*y^3*z^4 + 12*n^2*x*y^3*z^3 - 6*x*y^3*z^3 + 12*x*y^3*y00*z^2 + 6*x*y^3*z^2*z00 - x*y^3*z^2*z00^2 + n^2*x*y^2*z^3*z00^2 - 12*n^2*x*y^2*y00*z^3 - 12*x*y^4*z^2 + 6*n^2*x*y^2*z^4 - n^2*x*y^2*z^5
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (* (- 6) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6) (+ z 6)) (* 6 (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) (* (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00)) (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
