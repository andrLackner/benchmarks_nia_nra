...
; Benchmark: 		cohencu_denorm_inv1_len4_2
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (-x^3*y^2*z^3 - n^2*x*y^2*z^2 - n^3*x^2*z - n*y^3*z)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (- (* (- 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6)) (* (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6)))) 0))
			)
		)
	)
)
