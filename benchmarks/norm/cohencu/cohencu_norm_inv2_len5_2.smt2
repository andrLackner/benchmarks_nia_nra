...
; Benchmark: 		cohencu_norm_inv2_len5_2
...
; Testing invariant: n^3*x*y^3*z^3 - 6*n^3*x*y^3*z^2 + z00^2 - 12*n^3*x*y^4*z + 6*x^2*y^2*z^2*z00 - n^3*x*y^3*z*z00^2 + 0*n*z*z00^2 + 0*n*z*z00 + 0*n*y00*z - x^2*y^2*z^2*z00^2 + 0*n*y*z - z^2 + 12*n^3*x*y^3*y00*z + 0*n*z^3 + 0*n*z^2 + 6*n^3*x*y^3*z*z00 - 12*x^2*y^3*z^2 + x^2*y^2*z^4 - 6*x^2*y^2*z^3 - 12*y00 + 12*y + 12*x^2*y^2*y00*z^2 + 6*z - 6*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* z00 z00)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 6 (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00)) (* 0 (+ n 1) (+ z 6) z00 z00) (* 0 (+ n 1) (+ z 6) z00) (* 0 (+ n 1) y00 (+ z 6))) (* (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00)) (* 0 (+ n 1) (+ y z) (+ z 6))) (* (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6)) (* 0 (+ n 1) (+ z 6) (+ z 6) (+ z 6)) (* 0 (+ n 1) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00)) (* 12 (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 12 y00)) (* 12 (+ y z)) (* 12 (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6) (+ z 6)) (* 6 (+ z 6))) (* 6 z00)) 0))
			)
		)
	)
)
