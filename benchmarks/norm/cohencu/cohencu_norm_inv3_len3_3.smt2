...
; Benchmark: 		cohencu_norm_inv3_len3_3
...
; Testing invariant: -6*n*x*y^4*z^2 - 12*n*x^2*y*y00*z^3 - 72*n*x^2*y*y00*z^2 + 108*n*x^2*y^3*z - 6*n*x^2*y^2*z^3 + 108*n*x^3*y*z^2 + 108*x*x00*y*z^3 - n*x*y^3*z*z00^3 + 6*n*x*y^3*z*z00^2 - 108*x^2*y*z^3 + n*x^2*y*z^3*z00^2 - 72*n*x*y^3*y00*z + x*y*z^3*z00^3 - 6*x*y*z^3*z00^2 - x*y*z^4*z00^2 + 72*n*x*y^4*z + 18*n*x*y^3*y00*z*z00 + 72*x*y*y00*z^3 - n*x^2*y*z^2*z00^3 + 12*x*y*y00*z^4 + 6*n*x^2*y*z^2*z00^2 + 18*n*x^2*y*y00*z^2*z00 + 6*x*y^2*z^4 - 72*x*y^2*z^3 - 108*n*x^2*x00*y*z^2 - 6*n*x^2*y*z^3*z00 - 12*n*x*y^3*y00*z^2 + 72*n*x^2*y^2*z^2 - 18*x*y*y00*z^3*z00 + n*x*y^3*z^2*z00^2 - 6*n*x*y^3*z^2*z00 + 6*x*y*z^4*z00 - 108*n*x*x00*y^3*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 6) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ x y) (+ x y) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6)) (* 72 (+ n 1) (+ x y) (+ x y) (+ y z) y00 (+ z 6) (+ z 6))) (* 108 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 108 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6)) (* 108 (+ x y) x00 (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00 z00)) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00)) (* 108 (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 72 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6))) (* (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00 z00)) (* 6 (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00) (* (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 72 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6)) (* 18 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6) z00) (* 72 (+ x y) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) z00 z00 z00)) (* 12 (+ x y) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) z00 z00) (* 18 (+ n 1) (+ x y) (+ x y) (+ y z) y00 (+ z 6) (+ z 6) z00) (* 6 (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 72 (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 108 (+ n 1) (+ x y) (+ x y) x00 (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6) (+ z 6))) (* 72 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 18 (+ x y) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6) z00)) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00)) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) (* 6 (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00)) (* 108 (+ n 1) (+ x y) x00 (+ y z) (+ y z) (+ y z) (+ z 6))) 0))
			)
		)
	)
)
