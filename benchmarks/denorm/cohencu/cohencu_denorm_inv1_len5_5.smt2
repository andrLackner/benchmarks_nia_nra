...
; Benchmark: 		cohencu_denorm_inv1_len5_5
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (-x*y^2*z^3 - n*y*z^3 - n^3*y*z^3 - n*x^2*y^3*z + x*z^2)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (+ (- (* (- 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* (+ x y) (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
