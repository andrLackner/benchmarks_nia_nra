...
; Benchmark: 		cohencu_norm_inv1_len4_1
...
; Testing invariant: -6*n^3*x^2*y^3*z^2 - 6*n00*x^3*y*z^3 + 6*n^2*n00*x^2*y^3*z^2 + x^3*y*z^3*z00 + 6*n*x^3*y*z^3 + n^2*x^2*y^3*z^3 - 6*n*z + z^2 - n^2*x^2*y^3*z^2*z00 + 6*n*x*y*z^2 - 6*n00*x*y*z^2 - z*z00 - x*y*z^3 - x^3*y*z^4 + x*y*z^2*z00 + 6*n00*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (* (- 6) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 n00 (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ z 6))) (* (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) (* 6 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 6 n00 (+ x y) (+ y z) (+ z 6) (+ z 6)) (* (+ z 6) z00) (* (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ x y) (+ y z) (+ z 6) (+ z 6) z00) (* 6 n00 (+ z 6))) 0))
			)
		)
	)
)
