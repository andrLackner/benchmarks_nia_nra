...
; Benchmark: 		freire2_norm_inv2_len2_3
...
; Testing invariant: -3*r*s^2 + 4*r^2*s*s00 - 6*r*s^2*x^2*x00 + 12*r*r00^3*s^2*x^2 + 2*r^2*s^3*x^2 - 3*r*r00*s - 12*r^2*r00^2*s^2*x^2 + 3*r^2*s^2*x^2 - 6*r*s*x00 + 2*r^2*s^2 + 3*r*s*s00 - 6*r*r00*s*s00 - 12*r^2*r00^2*s + 4*r^2*s^2*s00*x^2 + 6*r*s^2*x^3 + 12*r*r00^3*s - 3*r*r00*s^2*x^2 + 6*r*s*x + 3*r^2*s - 6*r*r00*s^2*s00*x^2 + 3*r*s^2*s00*x^2 - 3*r*s^3*x^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 3) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* 4 (+ r 1) (+ r 1) (+ s (* 6 r) 3) s00)) (* 6 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) x00)) (* 12 (+ r 1) r00 r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* 2 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 3 (+ r 1) r00 (+ s (* 6 r) 3)) (* 12 (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 6 (+ r 1) (+ s (* 6 r) 3) x00)) (* 2 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ s (* 6 r) 3) s00)) (* 6 (+ r 1) r00 (+ s (* 6 r) 3) s00) (* 12 (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3))) (* 4 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s)) (* 6 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 12 (+ r 1) r00 r00 r00 (+ s (* 6 r) 3))) (* 3 (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 6 (+ r 1) (+ s (* 6 r) 3) (- x s)) (* 3 (+ r 1) (+ r 1) (+ s (* 6 r) 3))) (* 6 (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s))) (* 3 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s))) (* 3 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) 0))
			)
		)
	)
)
