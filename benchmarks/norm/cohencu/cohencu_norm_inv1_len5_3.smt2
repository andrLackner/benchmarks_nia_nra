...
; Benchmark: 		cohencu_norm_inv1_len5_3
...
; Testing invariant: 0*n^3*x*y^2*z^3 - 6*n^3*x^2*y^3*z + 6*n*x*y^2 + 6*n*x*y*z^3 - 6*n00*x*y*z^3 + n^2*x^2*y^3*z^2 + 0*n^2*x*y^2*z^4 + x*y^2*z00 + 0*n^2*x*y^2*z^3*z00 - 6*n00*x*y^2 - x*y^2*z + 6*n^2*n00*x^2*y^3*z + 0*n^2*n00*x*y^2*z^3 - n^2*x^2*y^3*z*z00 - x*y*z^4 + x*y*z^3*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (* 0 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z)) (* 6 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 n00 (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 0 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ x y) (+ y z) (+ y z) z00) (* 0 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00)) (* 6 n00 (+ x y) (+ y z) (+ y z)) (* (+ x y) (+ y z) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6)) (* 0 (+ n 1) (+ n 1) n00 (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00) (* (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00)) 0))
			)
		)
	)
)
