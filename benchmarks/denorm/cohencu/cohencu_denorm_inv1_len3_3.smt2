...
; Benchmark: 		cohencu_denorm_inv1_len3_3
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (-y*z + n^3*x^3*y*z^3 - n^3*x*z)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (- (+ (* (- 1) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ z 6)))) 0))
			)
		)
	)
)
