...
; Benchmark: 		cohencu_norm_inv2_len2_3
...
; Testing invariant: -6*n*x*z^4 + n*x*z^5 + 12*n*x*y00*z^3 - 12*n^2*x^2*y^4*z + 6*n*x*z^3*z00 - 12*n*x*y*z^3 + 6*n^2*x^2*y^3*z*z00 - n*x*z^3*z00^2 - 6*n^2*x^2*y^3*z^2 + n^2*x^2*y^3*z^3 - n^2*x^2*y^3*z*z00^2 + 12*n^2*x^2*y^3*y00*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (* (- 6) (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ x y) y00 (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00)) (* 12 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00)) (* (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00 z00) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6))) 0))
			)
		)
	)
)
