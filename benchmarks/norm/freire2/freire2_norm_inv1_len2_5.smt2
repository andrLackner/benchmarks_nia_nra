...
; Benchmark: 		freire2_norm_inv1_len2_5
...
; Testing invariant: 3*r^4*s^2*x^3 + r^2*s^2*s00*x^3 - r*s*s00*x - r^2*s^3*x^3 - 3*r^2*r00^2*s^2*x^3 + 3*r*r00^2*s*x - 3*r^3*s*x + r*s^2*x
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s))) (* (+ r 1) (+ s (* 6 r) 3) s00 (- x s)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 3 (+ r 1) r00 r00 (+ s (* 6 r) 3) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s))) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s))) 0))
			)
		)
	)
)
