...
; Benchmark: 		cohencu_norm_inv3_len2_4
...
; Testing invariant: -12*n*x*y00*z^4 - 18*x*y*y00*z*z00 + 12*x*y*y00*z^2 - 72*n*x*y00*z^3 + 72*x*y*y00*z + 72*n*x*y*z^3 - 6*n*x*y*z^4 - 6*x*y*z*z00^2 + 108*n*x^2*z^3 + x*y*z*z00^3 - 108*x^2*y*z + n*x*z^4*z00^2 - 108*n*x*x00*z^3 + 6*x*y^2*z^2 - 6*n*x*z^4*z00 - 72*x*y^2*z + 108*x*x00*y*z + 18*n*x*y00*z^3*z00 + 6*n*x*z^3*z00^2 - n*x*z^3*z00^3 + 6*x*y*z^2*z00 - x*y*z^2*z00^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 12) (+ n 1) (+ x y) y00 (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 18 (+ x y) (+ y z) y00 (+ z 6) z00)) (* 12 (+ x y) (+ y z) y00 (+ z 6) (+ z 6))) (* 72 (+ n 1) (+ x y) y00 (+ z 6) (+ z 6) (+ z 6))) (* 72 (+ x y) (+ y z) y00 (+ z 6)) (* 72 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ x y) (+ y z) (+ z 6) z00 z00)) (* 108 (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6)) (* (+ x y) (+ y z) (+ z 6) z00 z00 z00)) (* 108 (+ x y) (+ x y) (+ y z) (+ z 6))) (* (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 108 (+ n 1) (+ x y) x00 (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00) (* 72 (+ x y) (+ y z) (+ y z) (+ z 6))) (* 108 (+ x y) x00 (+ y z) (+ z 6)) (* 18 (+ n 1) (+ x y) y00 (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00 z00 z00)) (* 6 (+ x y) (+ y z) (+ z 6) (+ z 6) z00)) (* (+ x y) (+ y z) (+ z 6) (+ z 6) z00 z00)) 0))
			)
		)
	)
)
