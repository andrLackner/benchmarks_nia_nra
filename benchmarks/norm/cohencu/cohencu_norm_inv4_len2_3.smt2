...
; Benchmark: 		cohencu_norm_inv4_len2_3
...
; Testing invariant: -18*x^3*x00*y^2*z - n^2*x*y*z^2*z00 + 108*x^3*x00*y^2 + x^3*y^2*y00*z*z00 + 72*x^3*y^2*y00 + 24*n^2*x*y00^2*z - x^3*y^3*z*z00 - 18*x^3*x00*y^2*z00 - n^2*x*y00*z*z00^2 - 12*n^2*x*y*y00*z - 6*x^3*y^2*y00*z00 + 108*n^2*x*x00*z + x^3*y^3*z00^2 - 12*x^3*y^3*y00 + 6*x^3*y^3*z00 + 12*n^2*x*y*z^2 - 12*x^3*y^2*y00*z - 18*n^2*x*x00*z*z00 - 18*n^2*x*x00*z^2 + 18*n^2*x^2*z^2 + 18*x^4*y^2*z00 + n^2*x*y00*z^2*z00 - x^3*y^2*y00*z00^2 + n^2*x*y*z*z00^2 + 12*x^3*y^3*z - 12*n^2*x*y00*z^2 + 72*n^2*x*y00*z - 12*x^3*y^4 - 72*x^3*y^3 - 72*n^2*x*y*z + 18*x^4*y^2*z - 12*n^2*x*y^2*z - 108*x^4*y^2 + 6*n^2*x*y*z*z00 + 24*x^3*y^2*y00^2 - 6*n^2*x*y00*z*z00 - 108*n^2*x^2*z + 18*n^2*x^2*z*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 18) (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) z00)) (* 108 (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ y z)) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6) z00) (* 72 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00) (* 24 (+ n 1) (+ n 1) (+ x y) y00 y00 (+ z 6))) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00) (* 18 (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ y z) z00) (* (+ n 1) (+ n 1) (+ x y) y00 (+ z 6) z00 z00) (* 12 (+ n 1) (+ n 1) (+ x y) (+ y z) y00 (+ z 6)) (* 6 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 z00)) (* 108 (+ n 1) (+ n 1) (+ x y) x00 (+ z 6)) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) z00 z00)) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00)) (* 6 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) z00) (* 12 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6)) (* 18 (+ n 1) (+ n 1) (+ x y) x00 (+ z 6) z00) (* 18 (+ n 1) (+ n 1) (+ x y) x00 (+ z 6) (+ z 6))) (* 18 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6)) (* 18 (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) z00) (* (+ n 1) (+ n 1) (+ x y) y00 (+ z 6) (+ z 6) z00)) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 z00 z00)) (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) z00 z00) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ x y) y00 (+ z 6) (+ z 6))) (* 72 (+ n 1) (+ n 1) (+ x y) y00 (+ z 6))) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z)) (* 72 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z)) (* 72 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6))) (* 18 (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6)) (* 108 (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6) z00) (* 24 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 y00)) (* 6 (+ n 1) (+ n 1) (+ x y) y00 (+ z 6) z00) (* 108 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6))) (* 18 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6) z00)) 0))
			)
		)
	)
)
