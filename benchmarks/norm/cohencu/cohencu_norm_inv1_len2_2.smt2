...
; Benchmark: 		cohencu_norm_inv1_len2_2
...
; Testing invariant: -n*x*z^4 + 6*n^3*x^2*y*z - 6*n*n00*x*z^3 + n*x*z^3*z00 + 6*n^2*x*z^3 - 6*n^2*n00*x^2*y*z - n^2*x^2*y*z^2 + n^2*x^2*y*z*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (* (- 1) (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6))) (* 6 (+ n 1) n00 (+ x y) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) z00)) 0))
			)
		)
	)
)
