...
; Benchmark: 		cohencu_norm_inv1_len2_3
...
; Testing invariant: 6*n^2*n00*y^2*z - n^3*y^2*z^4 - n^2*y^2*z*z00 + n^3*y^2*z^3*z00 - 6*n^3*n00*y^2*z^3 - 6*n^3*y^2*z + n^2*y^2*z^2 + 6*n^4*y^2*z^3
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (* 6 (+ n 1) (+ n 1) n00 (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) z00)) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) n00 (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6))) (* (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
