...
; Benchmark: 		freire2_norm_inv2_len3_5
...
; Testing invariant: -6*r^3*r00*s^2*s00 + 3*r^3*s^3*x - 3*r*r00*x^2 - 12*r^2*r00^2*x^2 + 3*r^2*x^2 + 2*r^4*s^3 - 12*r^3*r00^3*s^2*x - 6*r*x^2*x00 + 12*r*r00^3*x^2 - 6*r^3*s^2*x00 + 3*r*s00*x^2 - 3*r^3*r00*s^2 - 3*r*s*x^2 - 3*r^4*s^2*x + 2*r^2*s*x^2 + 3*r^3*s^2*s00 - 12*r^4*r00^2*s^2 + 6*r^3*s^2*x*x00 - 6*r^3*s^2*x^2 + 3*r^3*r00*s^2*x + 4*r^2*s00*x^2 + 6*r^3*s^2*x + 6*r*x^3 - 3*r^3*s^3 + 6*r^3*r00*s^2*s00*x + 3*r^4*s^2 - 6*r*r00*s00*x^2 + 12*r^4*r00^2*s^2*x + 12*r^3*r00^3*s^2 - 2*r^4*s^3*x - 4*r^4*s^2*s00*x + 4*r^4*s^2*s00 - 3*r^3*s^2*s00*x
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 6) (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s))) (* 3 (+ r 1) r00 (- x s) (- x s)) (* 12 (+ r 1) (+ r 1) r00 r00 (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (- x s) (- x s)) (* 2 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 12 (+ r 1) (+ r 1) (+ r 1) r00 r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* 6 (+ r 1) (- x s) (- x s) x00)) (* 12 (+ r 1) r00 r00 r00 (- x s) (- x s))) (* 6 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) x00)) (* 3 (+ r 1) s00 (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s))) (* 2 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00)) (* 12 (+ r 1) (+ r 1) (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 6 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) x00)) (* 6 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* 4 (+ r 1) (+ r 1) s00 (- x s) (- x s)) (* 6 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* 6 (+ r 1) (- x s) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 6 (+ r 1) (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 6 (+ r 1) r00 s00 (- x s) (- x s))) (* 12 (+ r 1) (+ r 1) (+ r 1) (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* 12 (+ r 1) (+ r 1) (+ r 1) r00 r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 2 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* 4 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s))) (* 4 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00)) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s))) 0))
			)
		)
	)
)
