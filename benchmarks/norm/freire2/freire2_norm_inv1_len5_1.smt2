...
; Benchmark: 		freire2_norm_inv1_len5_1
...
; Testing invariant: -r*s^2 + r*s^4 - 3*r^3*s^3*x^2 - r^2*s*x^3 + 3*r^3*s^3*x + r*s^3*s00*x - 3*r^2*r00^2*x^3 + 3*r^4*x^3 - 3*r*r00^2*s^3*x + 3*r*r00^2*s^3 + r*s*s00 + 3*r*r00^2*s^3*x^2 - 3*r^3*s^3 - r*s^3*s00 - 3*r*r00^2*s + r^2*s00*x^3 - r*s^3*s00*x^2 + 3*r^3*s + r*s^4*x^2 - r*s^4*x
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s))) (* 3 (+ r 1) (+ r 1) r00 r00 (- x s) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1) (- x s) (- x s) (- x s))) (* 3 (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s))) (* 3 (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* (+ r 1) (+ s (* 6 r) 3) s00) (* 3 (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00) (* 3 (+ r 1) r00 r00 (+ s (* 6 r) 3))) (* (+ r 1) (+ r 1) s00 (- x s) (- x s) (- x s))) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3)) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s))) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s))) 0))
			)
		)
	)
)
