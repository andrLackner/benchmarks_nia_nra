...
; Benchmark: 		cohencu_norm_inv2_len3_5
...
; Testing invariant: 6*n^3*x^2*y^3*z - n^3*x^2*y^3*z^2 + 6*n^2*x^3*y^3*z^2*z00 - 12*n*x^3*y*z^3 - 6*n*x^3*z^4 + 6*n*x^3*z^3*z00 - n^2*x^3*y^3*z^2*z00^2 + n*x^3*z^5 + n^2*x^3*y^3*z^4 + n^3*x^2*y^3*z00^2 - 6*n^2*x^3*y^3*z^3 - 12*n^2*x^3*y^4*z^2 - n*x^3*z^3*z00^2 + 12*n*x^3*y00*z^3 + 12*n^2*x^3*y^3*y00*z^2 + 12*n^3*x^2*y^4 - 12*n^3*x^2*y^3*y00 - 6*n^3*x^2*y^3*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) z00 z00)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) y00 (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) z00)) 0))
			)
		)
	)
)
