...
; Benchmark: 		cohencu_norm_inv2_len4_1
...
; Testing invariant: n*x*y^3*z^5 - 6*n*x*y^3*z^4 + 12*x^3*y^3*z - 12*n*y^3*z^2 - n*y^2*z^2*z00^2 + 6*n*x*y^3*z^3*z00 - 12*n*x*y^4*z^3 + x^3*y^2*z*z00^2 - n^2*y^2*z^4 + n^2*y^2*z^2*z00^2 + 6*n^2*y^2*z^3 + 6*n*y^2*z^2*z00 - 6*n^2*y^2*z^2*z00 + 12*n^2*y^3*z^2 - x^3*y^2*z^3 - n*x*y^3*z^3*z00^2 + 6*x^3*y^2*z^2 + 12*n*y^2*y00*z^2 + 12*n*x*y^3*y00*z^3 - 12*x^3*y^2*y00*z - 12*n^2*y^2*y00*z^2 + n*y^2*z^4 - 6*n*y^2*z^3 - 6*x^3*y^2*z*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 12 (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00)) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00)) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00 z00)) (* (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00) (* 6 (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) (* 6 (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) (* 12 (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 6 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ y z) (+ y z) y00 (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ y z) (+ y z) y00 (+ z 6) (+ z 6))) (* (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00)) 0))
			)
		)
	)
)
