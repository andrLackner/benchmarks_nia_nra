...
; Benchmark: 		cohencu_norm_inv2_len4_3
...
; Testing invariant: -y*z^5 - 6*y*z^3*z00 - 6*y*z^2*z00 - 12*y*y00*z^2 + 6*n^3*x^3*y*z^3 - 12*y*y00*z^3 - n^3*x^3*y*z^4 + y*z^2*z00^2 - n*x^2*z^2*z00^2 - 6*n*x^2*z^3 + n*x^2*z^4 + n^3*x^3*y*z^2*z00^2 + 12*n*x^2*y00*z^2 - 12*n^3*x^3*y*y00*z^2 + 6*y*z^3 + 5*y*z^4 + 6*n*x^2*z^2*z00 + 12*n^3*x^3*y^2*z^2 - 6*n^3*x^3*y*z^2*z00 - 12*n*x^2*y*z^2 + 12*y^2*z^3 + y*z^3*z00^2 + 12*y^2*z^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 1) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ y z) (+ z 6) (+ z 6) z00) (* 12 (+ y z) y00 (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ y z) y00 (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* (+ y z) (+ z 6) (+ z 6) z00 z00)) (* (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) z00 z00) (* 6 (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) z00 z00) (* 12 (+ n 1) (+ x y) (+ x y) y00 (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6) (+ z 6))) (* 6 (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 5 (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) z00) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) z00) (* 12 (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 12 (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00) (* 12 (+ y z) (+ y z) (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
