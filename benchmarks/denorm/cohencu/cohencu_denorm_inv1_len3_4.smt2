...
; Benchmark: 		cohencu_denorm_inv1_len3_4
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (-y^3*z - n*x^3*y*z^3 + n^2*x^2*y^2)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (+ (- (* (- 1) (+ y z) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z)))) 0))
			)
		)
	)
)
