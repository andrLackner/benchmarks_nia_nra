...
; Benchmark: 		freire2_norm_inv1_len2_2
...
; Testing invariant: r^2*s00 + 3*r^3*s^3*x^3 + r*s^3*s00*x^3 - r^2*s + 3*r^4 - r*s^4*x^3 - 3*r^2*r00^2 - 3*r*r00^2*s^3*x^3
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (* (+ r 1) (+ r 1) s00) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00 (- x s) (- x s) (- x s))) (* (+ r 1) (+ r 1) (+ s (* 6 r) 3))) (* 3 (+ r 1) (+ r 1) (+ r 1) (+ r 1))) (* (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s)) (* 3 (+ r 1) (+ r 1) r00 r00) (* 3 (+ r 1) r00 r00 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s) (- x s))) 0))
			)
		)
	)
)
