...
; Benchmark: 		cohencu_norm_inv3_len3_5
...
; Testing invariant: -72*x^3*y^4*z - x^3*y^3*z^2*z00^2 + 108*n^3*x*y^2*z - n^2*x^3*y*z*z00^2 - 18*n^2*x^3*y*y00*z00 + 6*x^3*y^4*z^2 + n^2*x^3*y*z00^3 + 18*n^3*y^2*y00*z*z00 - 6*n^2*x^3*y*z00^2 + 108*n^2*x^3*x00*y - 108*x^4*y^3*z - n^3*y^2*z*z00^3 + 6*n^2*x^3*y*z*z00 + 6*n^3*y^2*z*z00^2 + n^3*y^2*z^2*z00^2 + 6*n^2*x^3*y^2*z - 108*n^3*x00*y^2*z - 108*n^2*x^4*y + 72*x^3*y^3*y00*z + 12*x^3*y^3*y00*z^2 + 108*x^3*x00*y^3*z + 72*n^2*x^3*y*y00 + 72*n^3*y^3*z + x^3*y^3*z*z00^3 + 6*x^3*y^3*z^2*z00 - 6*n^3*y^2*z^2*z00 - 72*n^3*y^2*y00*z - 6*n^3*y^3*z^2 - 6*x^3*y^3*z*z00^2 + 12*n^2*x^3*y*y00*z - 18*x^3*y^3*y00*z*z00 - 12*n^3*y^2*y00*z^2 - 72*n^2*x^3*y^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 72) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6)) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00)) (* 108 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) z00 z00) (* 18 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 z00)) (* 6 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) z00 z00 z00) (* 18 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) y00 (+ z 6) z00)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) z00 z00)) (* 108 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) x00 (+ y z))) (* 108 (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) z00 z00 z00)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) z00) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) z00 z00) (* (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6))) (* 108 (+ n 1) (+ n 1) (+ n 1) x00 (+ y z) (+ y z) (+ z 6)) (* 108 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z))) (* 72 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6)) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6) (+ z 6)) (* 108 (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ y z) (+ y z) (+ z 6)) (* 72 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00) (* 72 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6)) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00 z00) (* 6 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) z00) (* 72 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) y00 (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6))) (* 18 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6) z00) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) y00 (+ z 6) (+ z 6)) (* 72 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z))) 0))
			)
		)
	)
)
