...
; Benchmark: 		cohencu_norm_inv2_len3_2
...
; Testing invariant: -12*n*y^3*y00*z + 12*n*x^2*y^2*y00 - 6*n*y^3*z*z00 - n*y^3*z^3 + 6*n*y^3*z^2 + 6*n*x^2*y^2*z00 + n*y^3*z*z00^2 - n^3*x^2*z^2*z00^2 - 12*n^3*x^2*y*z^2 - 6*n*x^2*y^2*z - 12*n*x^2*y^3 - n*x^2*y^2*z00^2 + 6*n^3*x^2*z^2*z00 + n*x^2*y^2*z^2 - 6*n^3*x^2*z^3 + n^3*x^2*z^4 + 12*n^3*x^2*y00*z^2 + 12*n*y^4*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (* (- 12) (+ n 1) (+ y z) (+ y z) (+ y z) y00 (+ z 6)) (* 12 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) y00)) (* 6 (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) z00) (* (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) z00) (* (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) z00 z00) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)) (* 12 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z)) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) z00 z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) z00) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) y00 (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6))) 0))
			)
		)
	)
)
