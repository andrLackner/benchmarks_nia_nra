...
; Benchmark: 		cohencu_norm_inv1_len5_1
...
; Testing invariant: -n*x^2*y^3*z^2*z00 - 6*n00*x^2*y^2*z - 6*n*x*y^2 + 6*n*x^2*y^2*z - 6*n^3*n00*x^3 + n*z*z00 - 6*n^2*x^2*y^3*z^2 - n^3*x^3*z + 6*n^2*z - x*y^2*z00 + 6*n*n00*x^2*y^3*z^2 + n^3*x^3*z00 + 6*n00*x*y^2 + 6*n^4*x^3 - n*z^2 - x^2*y^2*z^2 + x*y^2*z + n*x^2*y^3*z^3 + x^2*y^2*z*z00 - 6*n*n00*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00) (* 6 n00 (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z))) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ x y))) (* (+ n 1) (+ z 6) z00)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ z 6))) (* (+ x y) (+ y z) (+ y z) z00)) (* 6 (+ n 1) n00 (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) z00) (* 6 n00 (+ x y) (+ y z) (+ y z)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y))) (* (+ n 1) (+ z 6) (+ z 6)) (* (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* (+ x y) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00)) (* 6 (+ n 1) n00 (+ z 6))) 0))
			)
		)
	)
)
