...
; Benchmark: 		cohencu_norm_inv3_len3_2
...
; Testing invariant: 72*n*x*y^2*z^3 + n*x*y*z^4*z00^2 - 6*n*x*y^2*z^4 - 108*n*x*x00*y*z^3 + 18*n*x*y*y00*z^3*z00 + 6*n^2*x*z*z00 - 12*n*y*y00*z^2 - 108*n*x00*y*z + 72*n^2*x*y00 + 6*n*y*z*z00^2 + 108*n^2*x*x00 + 108*n*x*y*z - 72*n*x*y*y00*z^3 - n^2*x*z*z00^2 + 108*n*x^2*y*z^3 - 12*n*x*y*y00*z^4 - 18*n^2*x*y00*z00 + 18*n*y*y00*z*z00 - 6*n*y^2*z^2 - 6*n*x*y*z^4*z00 + 12*n^2*x*y00*z + n*y*z^2*z00^2 + 6*n^2*x*y*z - n*y*z*z00^3 - 108*n^2*x^2 - 6*n*y*z^2*z00 + 6*n*x*y*z^3*z00^2 - n*x*y*z^3*z00^3 + n^2*x*z00^3 - 6*n^2*x*z00^2 - 72*n*y*y00*z - 72*n^2*x*y + 72*n*y^2*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* 72 (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 108 (+ n 1) (+ x y) x00 (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 18 (+ n 1) (+ x y) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ n 1) (+ x y) (+ z 6) z00)) (* 12 (+ n 1) (+ y z) y00 (+ z 6) (+ z 6)) (* 108 (+ n 1) x00 (+ y z) (+ z 6))) (* 72 (+ n 1) (+ n 1) (+ x y) y00) (* 6 (+ n 1) (+ y z) (+ z 6) z00 z00) (* 108 (+ n 1) (+ n 1) (+ x y) x00) (* 108 (+ n 1) (+ x y) (+ y z) (+ z 6))) (* 72 (+ n 1) (+ x y) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ z 6) z00 z00)) (* 108 (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ x y) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 18 (+ n 1) (+ n 1) (+ x y) y00 z00)) (* 18 (+ n 1) (+ y z) y00 (+ z 6) z00)) (* 6 (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00)) (* 12 (+ n 1) (+ n 1) (+ x y) y00 (+ z 6)) (* (+ n 1) (+ y z) (+ z 6) (+ z 6) z00 z00) (* 6 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6))) (* (+ n 1) (+ y z) (+ z 6) z00 z00 z00) (* 108 (+ n 1) (+ n 1) (+ x y) (+ x y)) (* 6 (+ n 1) (+ y z) (+ z 6) (+ z 6) z00)) (* 6 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00 z00)) (* (+ n 1) (+ n 1) (+ x y) z00 z00 z00)) (* 6 (+ n 1) (+ n 1) (+ x y) z00 z00) (* 72 (+ n 1) (+ y z) y00 (+ z 6)) (* 72 (+ n 1) (+ n 1) (+ x y) (+ y z))) (* 72 (+ n 1) (+ y z) (+ y z) (+ z 6))) 0))
			)
		)
	)
)
