...
; Benchmark: 		freire2_norm_inv3_len3_5
...
; Testing invariant: -3*r*r00*s*x + 3*r*s + 18*r*r00*x + 18*r*r00*x^2 + 18*r^2*x + 6*r*r00^2*s00 + 9*r^2*s00*x - 9*r*r00*s - 6*r^2*r00*s00*x - 9*r00*s*x + 18*r^2*x^2 - 18*r*x*x00 - 3*s00*x - 18*r*r00*x*x00 + 6*r00^2*s00*x + 2*s*s00*x - 6*r*r00^2*s - 6*r00^2*s*x - 6*r*s*x + 6*r*r00^2*s00*x - 9*r^2*s - 9*r^2*s*x + 18*r00*x^2 + 9*r00*s00*x + 2*r*s^2 - 18*r^2*x*x00 + 9*r^2*s00 + 2*s^2*x + 6*r^2*r00*s - 6*r^2*r00*s00 + 3*s*x - 4*r*s00^2 - 4*s00^2*x + 3*r*r00*s00*x + 6*r*s00*x + 6*r^2*r00*s*x + 2*r*s*s00 + 18*r*x^2 - 18*r*r00*x00 - 3*r*s00 + 2*r*s*s00*x - 18*r00*x*x00 + 9*r*r00*s00 - 4*r*s00^2*x - 6*r*r00^2*s*x + 2*r*s^2*x - 18*r^2*x00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 3) (+ r 1) r00 (+ s (* 6 r) 3) (- x s)) (* 3 (+ r 1) (+ s (* 6 r) 3)) (* 18 (+ r 1) r00 (- x s)) (* 18 (+ r 1) r00 (- x s) (- x s)) (* 18 (+ r 1) (+ r 1) (- x s)) (* 6 (+ r 1) r00 r00 s00) (* 9 (+ r 1) (+ r 1) s00 (- x s))) (* 9 (+ r 1) r00 (+ s (* 6 r) 3)) (* 6 (+ r 1) (+ r 1) r00 s00 (- x s)) (* 9 r00 (+ s (* 6 r) 3) (- x s))) (* 18 (+ r 1) (+ r 1) (- x s) (- x s))) (* 18 (+ r 1) (- x s) x00) (* 3 s00 (- x s)) (* 18 (+ r 1) r00 (- x s) x00)) (* 6 r00 r00 s00 (- x s)) (* 2 (+ s (* 6 r) 3) s00 (- x s))) (* 6 (+ r 1) r00 r00 (+ s (* 6 r) 3)) (* 6 r00 r00 (+ s (* 6 r) 3) (- x s)) (* 6 (+ r 1) (+ s (* 6 r) 3) (- x s))) (* 6 (+ r 1) r00 r00 s00 (- x s))) (* 9 (+ r 1) (+ r 1) (+ s (* 6 r) 3)) (* 9 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s))) (* 18 r00 (- x s) (- x s)) (* 9 r00 s00 (- x s)) (* 2 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 18 (+ r 1) (+ r 1) (- x s) x00)) (* 9 (+ r 1) (+ r 1) s00) (* 2 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)) (* 6 (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3))) (* 6 (+ r 1) (+ r 1) r00 s00)) (* 3 (+ s (* 6 r) 3) (- x s))) (* 4 (+ r 1) s00 s00) (* 4 s00 s00 (- x s))) (* 3 (+ r 1) r00 s00 (- x s)) (* 6 (+ r 1) s00 (- x s)) (* 6 (+ r 1) (+ r 1) r00 (+ s (* 6 r) 3) (- x s)) (* 2 (+ r 1) (+ s (* 6 r) 3) s00) (* 18 (+ r 1) (- x s) (- x s))) (* 18 (+ r 1) r00 x00) (* 3 (+ r 1) s00)) (* 2 (+ r 1) (+ s (* 6 r) 3) s00 (- x s))) (* 18 r00 (- x s) x00)) (* 9 (+ r 1) r00 s00)) (* 4 (+ r 1) s00 s00 (- x s)) (* 6 (+ r 1) r00 r00 (+ s (* 6 r) 3) (- x s))) (* 2 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s))) (* 18 (+ r 1) (+ r 1) x00)) 0))
			)
		)
	)
)
