...
; Benchmark: 		freire2_denorm_inv1_len3_3
...
; Testing invariant: (s00 - s + 3*r^2 - 3*r00^2) * (r + r^2 + r^3*x^2)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (- s00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1))) (* 3 r00 r00)) (+ r 1 (* (+ r 1) (+ r 1)) (* (+ r 1) (+ r 1) (+ r 1) (- x s) (- x s)))) 0))
			)
		)
	)
)
