...
; Benchmark: 		cohencu_norm_inv3_len3_4
...
; Testing invariant: 72*n^2*x^3*y*z^2 + 108*n*x^3*x00*y^2 - 6*n^2*x^3*y*z^3 + 72*n*x^3*y^2*y00 - n*x^3*y^2*z*z00^2 - 18*n*x^3*y^2*y00*z00 + 12*n*x^3*y^2*y00*z + 6*n*x^3*y^3*z - 6*n*x^3*y*z*z00 - 108*n*x^4*y^2 + 18*n^2*x^3*y00*z^2*z00 + 108*n^2*x^4*z^2 + 108*n*x^4*y - n*x^3*y*z00^3 + 6*n*x^3*y*z00^2 - 72*n*x^3*y*y00 - 108*n^2*x^3*x00*z^2 + 6*n^2*x^3*z^2*z00^2 - n^2*x^3*z^2*z00^3 + 18*n*x^3*y*y00*z00 - 6*n^2*x^3*z^3*z00 + 6*n*x^3*y^2*z*z00 + n*x^3*y*z*z00^2 + 72*n*x^3*y^2 - 6*n*x^3*y^2*z - 72*n*x^3*y^3 - 6*n*x^3*y^2*z00^2 - 108*n*x^3*x00*y + n*x^3*y^2*z00^3 - 12*n^2*x^3*y00*z^3 + n^2*x^3*z^3*z00^2 - 12*n*x^3*y*y00*z - 72*n^2*x^3*y00*z^2
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* 72 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6)) (* 108 (+ n 1) (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ y z))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 72 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00 z00) (* 18 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 z00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) z00) (* 108 (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z))) (* 18 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) y00 (+ z 6) (+ z 6) z00) (* 108 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6)) (* 108 (+ n 1) (+ x y) (+ x y) (+ x y) (+ x y) (+ y z))) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) z00 z00 z00)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) z00 z00)) (* 72 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00) (* 108 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) x00 (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) z00 z00)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) z00 z00 z00)) (* 18 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 z00)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) z00 z00) (* 72 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z))) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)) (* 72 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) z00 z00) (* 108 (+ n 1) (+ x y) (+ x y) (+ x y) x00 (+ y z))) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) z00 z00 z00)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) y00 (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6)) (* 72 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) y00 (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
