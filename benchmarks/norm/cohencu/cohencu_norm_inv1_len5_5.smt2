...
; Benchmark: 		cohencu_norm_inv1_len5_5
...
; Testing invariant: n*x*y^2*z^3 - n^3*x^2*y^3*z^4 - 6*n^2*x*y^2*z^2 - 6*n^3*n00*x^2*y^3*z^3 - x*y*z*z00 - n^2*y^2*z^4 + 6*n00*x^3*z + x^3*z^2 - n*x*y^2*z^2*z00 + n^2*y^2*z^3*z00 + n^3*x^2*y^3*z^3*z00 + 6*n*n00*x*y^2*z^2 - x^3*z*z00 + 6*n^3*y^2*z^3 - 6*n*x*y*z + 6*n^4*x^2*y^3*z^3 + 6*n00*x*y*z - 6*n*x^3*z + x*y*z^2 - 6*n^2*n00*y^2*z^3
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ x y) (+ y z) (+ z 6) z00) (* (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 6 n00 (+ x y) (+ x y) (+ x y) (+ z 6)) (* (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) (* (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) n00 (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* (+ x y) (+ x y) (+ x y) (+ z 6) z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 n00 (+ x y) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6))) (* (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) n00 (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
