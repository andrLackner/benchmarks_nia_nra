...
; Benchmark: 		cohencu_norm_inv2_len2_1
...
; Testing invariant: n^3*x*y^3*z^4 + 12*n^3*x*y^3*y00*z^2 - 6*n^3*x*y^3*z^3 - 12*n^3*x*y^4*z^2 + 6*n^2*x^3*y*z^2 - 6*n^2*x^3*y*z*z00 - n^2*x^3*y*z^3 - 12*n^2*x^3*y*y00*z + 6*n^3*x*y^3*z^2*z00 + n^2*x^3*y*z*z00^2 - n^3*x*y^3*z^2*z00^2 + 12*n^2*x^3*y^2*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) z00) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) z00 z00)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6))) 0))
			)
		)
	)
)
