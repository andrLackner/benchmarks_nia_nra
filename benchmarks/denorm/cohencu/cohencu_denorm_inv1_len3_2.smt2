...
; Benchmark: 		cohencu_denorm_inv1_len3_2
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (-n*x*z^2 - n^2*x^3*y^2*z + n*x*y)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (+ (- (* (- 1) (+ n 1) (+ x y) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6))) (* (+ n 1) (+ x y) (+ y z)))) 0))
			)
		)
	)
)
