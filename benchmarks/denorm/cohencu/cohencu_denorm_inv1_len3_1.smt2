...
; Benchmark: 		cohencu_denorm_inv1_len3_1
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (-n^3*y^3*z + n^3*x^2*y*z^3 - n*x^3*y^2*z)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (- (+ (* (- 1) (+ n 1) (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)))) 0))
			)
		)
	)
)
