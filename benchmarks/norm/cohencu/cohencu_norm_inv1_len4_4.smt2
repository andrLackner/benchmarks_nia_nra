...
; Benchmark: 		cohencu_norm_inv1_len4_4
; Created:   		2022-01-05 21:34
...
; Testing invariant: -6*n^3*x*y^3*z^3 + 6*n^3*x^2*y^3*z^2 - 6*n^2*n00*x^2*y^3*z^2 - n^2*x^2*y*z^2 + n^2*x^2*y*z*z00 - n^2*x^2*y^3*z^3 + n^2*x*y^3*z^4 + n^2*x^2*y^3*z^2*z00 - 6*n*n00*y^3 + 6*n^3*x^2*y*z - 6*n^2*n00*x^2*y*z + 6*n^2*y^3 + n*y^3*z00 + 6*n^2*n00*x*y^3*z^3 - n^2*x*y^3*z^3*z00 - n*y^3*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 6) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) z00)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) z00)) (* 6 (+ n 1) n00 (+ y z) (+ y z) (+ y z))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) n00 (+ x y) (+ x y) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ y z) (+ y z) (+ y z)) (* (+ n 1) (+ y z) (+ y z) (+ y z) z00) (* 6 (+ n 1) (+ n 1) n00 (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6))) 0))
			)
		)
	)
)
