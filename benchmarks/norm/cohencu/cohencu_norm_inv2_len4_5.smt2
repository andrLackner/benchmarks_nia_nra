...
; Benchmark: 		cohencu_norm_inv2_len4_5
...
; Testing invariant: -n*x*y*z*z00^2 + 12*n*x*y*y00*z - n*x^3*z^2*z00^2 + 12*n^2*x*y00*z + 6*n^2*x*z*z00 - 12*x*y^3*y00 - 12*n*x^3*y*z^2 - 6*n*x^3*z^3 + 6*n*x^3*z^2*z00 + n*x*y*z^3 + n*x^3*z^4 - 12*n^2*x*y*z + 12*x*y^4 - 6*x*y^3*z00 + 12*n*x^3*y00*z^2 - x*y^3*z^2 + n^2*x*z^3 - 6*n^2*x*z^2 - 6*n*x*y*z^2 + 6*x*y^3*z - n^2*x*z*z00^2 + x*y^3*z00^2 + 6*n*x*y*z*z00 - 12*n*x*y^2*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 1) (+ n 1) (+ x y) (+ y z) (+ z 6) z00 z00) (* 12 (+ n 1) (+ x y) (+ y z) y00 (+ z 6))) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ n 1) (+ x y) y00 (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ z 6) z00)) (* 12 (+ x y) (+ y z) (+ y z) (+ y z) y00) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) z00) (* (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ x y) (+ y z) (+ z 6))) (* 12 (+ x y) (+ y z) (+ y z) (+ y z) (+ y z))) (* 6 (+ x y) (+ y z) (+ y z) (+ y z) z00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ x y) y00 (+ z 6) (+ z 6))) (* (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ x y) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 6 (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* (+ n 1) (+ n 1) (+ x y) (+ z 6) z00 z00)) (* (+ x y) (+ y z) (+ y z) (+ y z) z00 z00) (* 6 (+ n 1) (+ x y) (+ y z) (+ z 6) z00)) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6))) 0))
			)
		)
	)
)
