...
; Benchmark: 		cohencu_denorm_inv1_len5_2
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (-n^2*x*y^3*z + x^2*y^2*z^3 + n^2*x^2*y^2*z^2 + n^2*x^2*y^2 - n^3*x^3*y^3)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (- (+ (* (- 1) (+ n 1) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6)) (* (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z)))) 0))
			)
		)
	)
)
