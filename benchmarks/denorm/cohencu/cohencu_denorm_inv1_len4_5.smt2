...
; Benchmark: 		cohencu_denorm_inv1_len4_5
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (-n*y^3*z^3 + n^2 - n*x^3*y*z^3 - x^2*z)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (- (+ (* (- 1) (+ n 1) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1))) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* (+ x y) (+ x y) (+ z 6)))) 0))
			)
		)
	)
)
