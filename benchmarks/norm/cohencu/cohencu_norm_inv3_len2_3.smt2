...
; Benchmark: 		cohencu_norm_inv3_len2_3
...
; Testing invariant: -6*n^3*x^2*y^3*z^3 + 72*n*y00*z^2 + n^3*x^2*y^2*z^3*z00^2 + 6*n*y*z^3 - 108*n*x*z^2 + 72*n^3*x^2*y^3*z^2 - 12*n^3*x^2*y^2*y00*z^3 - 72*n*y*z^2 + 12*n*y00*z^3 - 72*n^3*x^2*y^2*y00*z^2 - 18*n*y00*z^2*z00 - n^3*x^2*y^2*z^2*z00^3 + 6*n^3*x^2*y^2*z^2*z00^2 + 108*n*x00*z^2 - 6*n*z^2*z00^2 + n*z^2*z00^3 - 108*n^3*x^2*x00*y^2*z^2 - 6*n^3*x^2*y^2*z^3*z00 - n*z^3*z00^2 + 18*n^3*x^2*y^2*y00*z^2*z00 + 108*n^3*x^3*y^2*z^2 + 6*n*z^3*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 6) (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6)) (* 72 (+ n 1) y00 (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00 z00) (* 6 (+ n 1) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 108 (+ n 1) (+ x y) (+ z 6) (+ z 6))) (* 72 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) (+ z 6)) (* 72 (+ n 1) (+ y z) (+ z 6) (+ z 6))) (* 12 (+ n 1) y00 (+ z 6) (+ z 6) (+ z 6))) (* 72 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6) (+ z 6)) (* 18 (+ n 1) y00 (+ z 6) (+ z 6) z00) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00 z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) z00 z00) (* 108 (+ n 1) x00 (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ z 6) (+ z 6) z00 z00)) (* (+ n 1) (+ z 6) (+ z 6) z00 z00 z00)) (* 108 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) x00 (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6) z00) (* (+ n 1) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 18 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6) (+ z 6) z00) (* 108 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ z 6) (+ z 6) (+ z 6) z00)) 0))
			)
		)
	)
)
