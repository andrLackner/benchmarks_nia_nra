...
; Benchmark: 		cohencu_denorm_inv1_len5_3
...
; Testing invariant: (-z + z00 + 6*n - 6*n00) * (n^2*x^2 - n*x^3*y^2 + n*x*y^3*z^3 - n^3*x^2*z^2 - n*z)
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (* (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00)) (- (+ (- (* (+ n 1) (+ n 1) (+ x y) (+ x y)) (* (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z))) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ z 6) (+ z 6)) (* (+ n 1) (+ z 6)))) 0))
			)
		)
	)
)
