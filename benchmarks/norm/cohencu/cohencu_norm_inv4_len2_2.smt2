...
; Benchmark: 		cohencu_norm_inv4_len2_2
...
; Testing invariant: -12*n*x*y^5 + 72*x^3*y^2*z - n*x*y^4*z*z00 + 18*n*x^2*y^3*z00 - 72*n*x*y^4 - x^3*y*y00*z^2*z00 + 18*n*x^2*y^3*z - 108*n*x^2*y^3 + n*x*y^4*z00^2 + 108*n*x*x00*y^3 - 12*n*x*y^3*y00*z - 72*x^3*y*y00*z + 72*n*x*y^3*y00 + 12*x^3*y^2*y00*z + 18*x^3*x00*y*z^2 + 12*n*x*y^4*z + 18*x^3*x00*y*z*z00 - 18*x^4*y*z*z00 + x^3*y^2*z^2*z00 + n*x*y^3*y00*z*z00 + 12*x^3*y^3*z - 108*x^3*x00*y*z + x^3*y*y00*z*z00^2 + 24*n*x*y^3*y00^2 - 24*x^3*y*y00^2*z - 6*n*x*y^3*y00*z00 - x^3*y^2*z*z00^2 + 108*x^4*y*z - 18*x^4*y*z^2 - n*x*y^3*y00*z00^2 - 12*x^3*y^2*z^2 - 18*n*x*x00*y^3*z00 + 12*x^3*y*y00*z^2 + 6*n*x*y^4*z00 - 12*n*x*y^4*y00 - 6*x^3*y^2*z*z00 + 6*x^3*y*y00*z*z00 - 18*n*x*x00*y^3*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 12) (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ y z)) (* 72 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6))) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6) z00)) (* 18 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) z00)) (* 72 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z)) (* (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6) (+ z 6) z00)) (* 18 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 108 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z))) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) z00 z00) (* 108 (+ n 1) (+ x y) x00 (+ y z) (+ y z) (+ y z))) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6)) (* 72 (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6))) (* 72 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) y00 (+ z 6)) (* 18 (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ z 6) (+ z 6)) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6)) (* 18 (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ z 6) z00)) (* 18 (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) z00)) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6) z00) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6) z00) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* 108 (+ x y) (+ x y) (+ x y) x00 (+ y z) (+ z 6))) (* (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6) z00 z00) (* 24 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 y00)) (* 24 (+ x y) (+ x y) (+ x y) (+ y z) y00 y00 (+ z 6)) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 z00) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00 z00)) (* 108 (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6))) (* 18 (+ x y) (+ x y) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) y00 z00 z00) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 18 (+ n 1) (+ x y) x00 (+ y z) (+ y z) (+ y z) z00)) (* 12 (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) z00)) (* 12 (+ n 1) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) y00) (* 6 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) z00)) (* 6 (+ x y) (+ x y) (+ x y) (+ y z) y00 (+ z 6) z00)) (* 18 (+ n 1) (+ x y) x00 (+ y z) (+ y z) (+ y z) (+ z 6))) 0))
			)
		)
	)
)
