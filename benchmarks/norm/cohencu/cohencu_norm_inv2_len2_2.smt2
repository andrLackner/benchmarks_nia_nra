...
; Benchmark: 		cohencu_norm_inv2_len2_2
...
; Testing invariant: -n*x^2*y^3*z*z00^2 + 12*n^3*x^2*y*y00 - 6*n^3*x^2*y*z + 6*n^3*x^2*y*z00 - 12*n*x^2*y^4*z - 6*n*x^2*y^3*z^2 + n^3*x^2*y*z^2 + n*x^2*y^3*z^3 - 12*n^3*x^2*y^2 - n^3*x^2*y*z00^2 + 12*n*x^2*y^3*y00*z + 6*n*x^2*y^3*z*z00
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (+ (- (+ (- (+ (- (+ (* (- 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00 z00) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) y00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) z00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ y z) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6))) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6) (+ z 6))) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) z00 z00)) (* 12 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) y00 (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00)) 0))
			)
		)
	)
)
