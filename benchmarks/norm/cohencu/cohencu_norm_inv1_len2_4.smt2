...
; Benchmark: 		cohencu_norm_inv1_len2_4
...
; Testing invariant: x*z^4 + 6*n*x^3*y^3*z - x*z^3*z00 - 6*n*x*z^3 + 6*n00*x*z^3 + x^3*y^3*z*z00 - x^3*y^3*z^2 - 6*n00*x^3*y^3*z
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (* (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) (* (+ x y) (+ z 6) (+ z 6) (+ z 6) z00) (* 6 (+ n 1) (+ x y) (+ z 6) (+ z 6) (+ z 6))) (* 6 n00 (+ x y) (+ z 6) (+ z 6) (+ z 6)) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) z00)) (* (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 n00 (+ x y) (+ x y) (+ x y) (+ y z) (+ y z) (+ y z) (+ z 6))) 0))
			)
		)
	)
)
