...
; Benchmark: 		cohencu_norm_inv3_len2_2
...
; Testing invariant: -x*z^4*z00^2 + 6*n^3*x^2*y^2*z + 108*x*x00*z^3 + 6*x*z^4*z00 - 108*x^2*z^3 - n^3*x^2*y*z*z00^2 - 6*n^3*x^2*y*z00^2 + 72*x*y00*z^3 + n^3*x^2*y*z00^3 + 12*x*y00*z^4 - 18*x*y00*z^3*z00 + 72*n^3*x^2*y*y00 - 108*n^3*x^3*y - 6*x*z^3*z00^2 + 12*n^3*x^2*y*y00*z - 18*n^3*x^2*y*y00*z00 + 6*n^3*x^2*y*z*z00 + x*z^3*z00^3 - 72*n^3*x^2*y^2 + 6*x*y*z^4 + 108*n^3*x^2*x00*y - 72*x*y*z^3
;--------------------------------------------------------------------------
...
(assert 
	(exists
		...
		(and
			...
			(or
				(not (= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* (- 1) (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00 z00) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)) (* 108 (+ x y) x00 (+ z 6) (+ z 6) (+ z 6)) (* 6 (+ x y) (+ z 6) (+ z 6) (+ z 6) (+ z 6) z00)) (* 108 (+ x y) (+ x y) (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) z00 z00) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) z00 z00)) (* 72 (+ x y) y00 (+ z 6) (+ z 6) (+ z 6)) (* (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) z00 z00 z00) (* 12 (+ x y) y00 (+ z 6) (+ z 6) (+ z 6) (+ z 6))) (* 18 (+ x y) y00 (+ z 6) (+ z 6) (+ z 6) z00)) (* 72 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) y00)) (* 108 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ x y) (+ y z)) (* 6 (+ x y) (+ z 6) (+ z 6) (+ z 6) z00 z00)) (* 12 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) y00 (+ z 6))) (* 18 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) y00 z00)) (* 6 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) z00) (* (+ x y) (+ z 6) (+ z 6) (+ z 6) z00 z00 z00)) (* 72 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z))) (* 6 (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6) (+ z 6)) (* 108 (+ n 1) (+ n 1) (+ n 1) (+ x y) (+ x y) x00 (+ y z))) (* 72 (+ x y) (+ y z) (+ z 6) (+ z 6) (+ z 6))) 0))
			)
		)
	)
)
